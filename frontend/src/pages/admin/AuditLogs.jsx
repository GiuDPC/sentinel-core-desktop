                ...
                <div className='absolute left-0 mt-2 z-50 w-48 p-2 border border-slate-200 rounded-md shadow-lg bg-white overflow-hidden'>
                  <div className='flex flex-col gap-1'>
                    {ACTION_OPTIONS.map((opt) => (
                      ...
                      >
                        <div className={`h-3.5 w-3.5 rounded border flex items-center justify-center transition-colors ${filters.action === opt.value ? 'bg-blue-600 border-blue-600' : 'border-slate-300'}`}>
